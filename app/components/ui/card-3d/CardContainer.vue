<template>
  <div
    :class="['flex items-center justify-center p-2 w-full h-full', containerClass]"
    style="perspective: 1000px"
  >
    <div
      ref="containerRef"
      :class="[
        'relative flex items-center justify-center transition-all duration-200 ease-linear w-full h-full',
        $props.class,
      ]"
